...
class ownership_contract(models.Model):
    ...
    def _default_income_account(self):
        account_income = self.env['ir.config_parameter'].sudo().get_param('rishvi_real_estate.income_account')
    ...
    def onchange_unit(self):
        ...
        self.building = self.building_unit.building_id
        self.region = self.building_unit.region_id
    ...
    def onchange_reservation(self):
        ...
        self.building = self.reservation_id.building
        self.region = self.reservation_id.region
        self.building_code = self.reservation_id.building_code
        self.partner_id = self.reservation_id.partner_id
        self.building_unit = self.reservation_id.building_unit
        ...
        self.template_id = self.reservation_id.template_id
        ...
        if self.template_id:
            self.loan_line = [(5, 0, 0)] + self._prepare_lines(self.date_payment)
