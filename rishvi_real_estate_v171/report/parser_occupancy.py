...
class Parser(models.AbstractModel):
	_name = 'report.rishvi_real_estate.report_occupancy'
	_description = 'Report Occupancy'
	...
	def _get_report_values(self, docids, data=None):
		...
		occupancy = self.env['ir.actions.report']._get_report_from_name('rishvi_real_estate.report_occupancy')
		return {
			'doc_ids': self.ids,
