...
class RoomBookingWizard(models.TransientModel):
    ...
    def action_room_booking_pdf(self):
        ...
        return self.env.ref(
            "rishvi_hotel_management_system.action_report_room_booking"
    ...
    def action_room_booking_excel(self):
        ...
        # Prepare data for the report - IMPORTANT: Keep it simple
        options = {
            "booking": booking_data,
        }

        # Return the proper action for Excel report
        return {
            "type": "ir.actions.report",
            "report_type": "xlsx",
            "report_name": "rishvi_hotel_management_system.report_room_booking_xlsx",
            "data": {
