...
//        // Call Odoo's dataset call_kw endpoint to execute the model method
//        await rpc('/web/dataset/call_kw', {
//            model: 'partner.similarity',
//            method: 'merge_the_user',
//            args: [[]],  // call on empty recordset
//            kwargs: {},
//        });
//
//        // show success
//        this.notification.add("partners have been merged successfully!", {
//            type: "success",
//            sticky: true,
//        });
//    } catch (error) {
//        console.error("merging partners failed:", error);
//        this.notification.add(
//            "Failed to merge partners: " + (error.message || "Unknown error"),
//            { type: "danger", sticky: true }
//        );
//    } finally {
//        this.state.loading = false;
...
//     // Get data from DOM
//     const rishviData = [
//         parseInt(document.getElementById('rishvi-draft').textContent),
//         parseInt(document.getElementById('rishvi-confirmed').textContent),
//         parseInt(document.getElementById('rishvi-cancelled').textContent),
//         parseInt(document.getElementById('rishvi-synced').textContent),
//     ];

//     const linnworksData = [
//         parseInt(document.getElementById('lineworks-pending').textContent),
//         parseInt(document.getElementById('lineworks-processed').textContent),
//         parseInt(document.getElementById('lineworks-dispatched').textContent),
//         parseInt(document.getElementById('lineworks-returned').textContent),
//     ];

//     // Destroy if previously rendered
//     if (this.rishviChart) this.rishviChart.destroy();
//     if (this.linnworksChart) this.linnworksChart.destroy();

//     // Draw Rishvi Orders Chart
//     this.rishviChart = new Chart(this.rishviPieChartRef.el, {
//         type: 'pie',
//         data: {
//             labels: ['Quotation', 'Sale Order', 'Cancelled', 'Synced'],
//             datasets: [{
//                 data: rishviData,
...
//     // Draw Linnworks Orders Chart
//     this.linnworksChart = new Chart(this.linnworksPieChartRef.el, {
//         type: 'bar',
//         data: {
//             labels: ['Pending', 'Processed', 'Dispatched', 'Returned'],
//             datasets: [{
//                 data: linnworksData,
...
OrderDashboard.template = "rishvi_orders.OrderManagementDashboard";
