...
class LinnOrderImportController(http.Controller):
    ...
    @http.route('/order/status_counts', type='json', auth='user', methods=['GET', 'POST'])
    ...
    @http.route('/linnworks/Order/get-countries', type='json', auth='user', csrf=False)
    ...
    @http.route('/my/api/order/sync_orders_by_page', type='json', auth='user', methods=['GET', 'POST'])
