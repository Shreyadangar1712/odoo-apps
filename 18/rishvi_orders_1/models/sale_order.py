...
class SaleOrder(models.Model):
    ...
    def _sync_shipping_line(self):
        ...
        for order in self:
            ...
            line_vals = {
                ...
                'tax_id': [(6, 0, [])],  # no tax on shipping line by default
                'sequence': 99999,
            }
    ...
    def _ensure_shipping_line(self, order):
        ...
        vals = {
            ...
            'tax_id': [(6, 0, product.taxes_id.ids)] if product and product.taxes_id else False,
        }
                    ...
                    "orderItems": [
                        {
                            ...
                            "taxRate": sum(t.amount for t in line.tax_id) if line.tax_id else 0.0,
