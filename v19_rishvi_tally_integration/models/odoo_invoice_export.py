...
class TallyExportInvoice(models.Model):
    ...
    state = fields.Selection([('draft', 'Draft'),
        ...
        ('failed', 'Failed')], string='Status',  store=True, default='draft', copy=False)
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get('name', _('New')) == _('New'):
                vals['name'] = self.env['ir.sequence'].next_by_code('tally.export.invoice') or _('New')
        return super(TallyExportInvoice, self).create(vals_list)
