...
class Parser(models.AbstractModel):
    _name = 'report.rishvi_real_estate.report_late_payments_units'
    _description = 'Report Late Payments Units'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        due_payment = self.env['ir.actions.report']._get_report_from_name('rishvi_real_estate.report_late_payments_units')
