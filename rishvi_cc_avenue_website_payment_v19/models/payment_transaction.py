...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_rendering_values(self, processing_values):
        ...
        # 🔥 DEBUG LOGS
        _logger.info("========== CCAvenue DEBUG ==========")
        _logger.info("Rendering Values: %s", rendering_vals)
        _logger.info("API URL: %s", rendering_vals.get('api_url'))
        _logger.info("Access Code: %s", rendering_vals.get('access_code'))
        _logger.info("Encrypted Data exists: %s", bool(rendering_vals.get('encrypted_data')))
        _logger.info("====================================")

        return rendering_vals
