...
class StockRule(models.Model):                                                                                                                                                                                                                                                                                                     
    ...
    action = fields.Selection(
        selection_add=[("split_procurement", "Dropship and Purchase")],
        ondelete={"split_procurement": "cascade"},
    )
    mts_rule_id = fields.Many2one("stock.rule", string="Rule Cusomer", check_company=True)
    mto_rule_id = fields.Many2one("stock.rule", string="Rule Vendor", check_company=True)
