...
##########################################################################
{
    ...
    'assets': {
        'web.assets_qweb': [
            'rishvi_real_estate/static/src/xml/*.xml',
        ],
        'web.assets_backend': [
            'rishvi_real_estate/static/src/js/init.js',
            'rishvi_real_estate/static/src/js/map_widget.js',
            'rishvi_real_estate/static/src/js/map_widget_multi.js',
            'rishvi_real_estate/static/src/js/place_autocomplete.js',
