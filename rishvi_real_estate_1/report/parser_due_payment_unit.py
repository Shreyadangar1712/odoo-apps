...
class Parser(models.AbstractModel):
    _name = 'report.rishvi_real_estate.report_due_payments_units'
    _description = 'Report Due Payments Units'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        due_payment = self.env['ir.actions.report']._get_report_from_name('rishvi_real_estate.report_due_payments_units')
        return {
            'doc_ids': self.ids,
